...
test('test action: Attack player with a non attacking item', () => {
	...
	expect(play.hit(gso1, card1, card2)).toEqual(gso1);
});
...
//User attacks Player, has Item that's not a shield, Reflect destroyed
test('test action: Attack player, has item, Reflect half destroyed', () => {
	let gso1 = { 
		players : [
		{
			character: "ivan",
...
//User attacks Player, has Item that's not a shield, Reflect survives
test('test action: Attack player, has item, Reflect half survives', () => {
	let gso1 = { 
		players : [
		{
			character: "ivan",
	...
	let gso2 = { 
		players : [
		{
			...
			played: [{ name: 'Cat-Bajun', type: 'Action', effect: 'Hit', points: 1 },],
		},
		{
			character: "koschei",
			health: 5,
			...
			played: [],
			item:  { name: 'Magical Mirror', type: 'Item', effect: 'Reflect half', points: 1 },
		}
		],
		activePlayer : 0,
		activeActions: 2
...
//User attacks Player, has Reflect Half item
test('test action: Attack player, has Reflect Half item', () => {
	let gso1 = { 
		players : [
		{
			character: "ivan",
...
//User attacks and has attack modificationg item
test('test action: Attacking player has modification item' , () => {
});
